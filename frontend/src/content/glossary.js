...
export const GLOSSARY_TERMS = [
  { id: "apn", help: "/help/troubleshooting", term: "APN", letter: "A", badge: "Core", seeAlso: ["mno"],
  ...
  { id: "esim", help: "/what-is-esim", term: "eSIM", letter: "E", badge: "Essential", seeAlso: [],
  ...
  { id: "eid", help: "/help/devices", term: "EID", letter: "E",
  ...
  { id: "iccid", help: "/help/account", term: "ICCID", letter: "I",
  ...
  { id: "imei", help: "/help/devices", term: "IMEI", letter: "I",
  ...
  { id: "lte", help: "/help/coverage", term: "LTE", letter: "L",
  ...
  { id: "mno", help: "/help/coverage", term: "MNO", letter: "M",
  ...
  { id: "mvno", help: "/help/coverage", term: "MVNO", letter: "M",
  ...
  { id: "roaming", help: "/help/activation", term: "Roaming", letter: "R",
  ...
  { id: "vpn", help: "/help/usage", term: "VPN", letter: "V",
  ...
  { id: "volte", help: "/help/activation", term: "VoLTE", letter: "V", badge: "New",
  ...
  { id: "sm-dp-plus", term: "SM-DP+", letter: "S", badge: "Core", seeAlso: ["esim", "eid"], help: "/help/installation",
    definition: "Subscription Manager Data Preparation. The server that stores your eSIM profile and hands it to your phone during installation. Its address is printed under the QR code in your order email, alongside the activation code, for installing manually when scanning is not possible." },
];
